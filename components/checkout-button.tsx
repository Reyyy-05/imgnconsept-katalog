...
import { generateWhatsAppURL, formatRupiah } from "@/lib/utils"
...
export default function CheckoutButton() {
  ...
  const handleCheckout = () => {
    ...
    const url = generateWhatsAppURL(orderItems)
  ...
  return (
    <div className="border-t border-card-border pt-4">
      ...
      <button
        onClick={clearCart}
        className="mt-3 w-full py-2 text-xs text-muted transition-colors hover:text-red-500"
      >
        Kosongkan Keranjang
      </button>
    </div>
